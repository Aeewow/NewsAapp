...
import com.example.newsaapp.databinding.FragmentSearchBinding
import com.example.newsaapp.ui.NewsActivity
import com.example.newsaapp.ui.NewsViewModel
import com.example.newsaapp.util.Constants
import com.example.newsaapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
            ...
            when(response){
                ...
                is Resource.Error<*> -> {
                    ...
                    response.message?.let { message ->
                        Toast.makeText(activity, "Извините, возникла ошибка: $message", Toast.LENGTH_LONG).show()
